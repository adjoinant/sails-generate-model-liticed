...
<!--
```sh
$ npm install sails-generate-model-liticed
```
-->
...
sailsgen(require('sails-generate-model-liticed'), scope, function (err) {
	if (err) throw err;
...
```sh
$ git clone YOUR_FORK_OF_THIS_REPO sails-generate-model-liticed-fork
$ cd sails-generate-model-liticed-fork
$ npm install
$ node ./bin
```
